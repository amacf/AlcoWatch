...
public class Quaternion {
    ...
    public Quaternion(Vector3 v, float angle, boolean a){
        this.x = v.x;
        this.y = v.y;
        this.z = v.z;
        this.w = angle;
    ...
    public Quaternion(float x, float y, float z) {
        this.w = (float) (Math.cos(x / 2) * Math.cos(y / 2) * Math.cos(z / 2) + Math.sin(x / 2) * Math.sin(y / 2) * Math.sin(z / 2));
        this.x = (float) (Math.sin(x / 2) * Math.cos(y / 2) * Math.cos(z / 2) - Math.cos(x / 2) * Math.sin(y / 2) * Math.sin(z / 2));
        this.y = (float) (Math.cos(x / 2) * Math.sin(y / 2) * Math.cos(z / 2) + Math.sin(x / 2) * Math.cos(y / 2) * Math.sin(z / 2));
        this.z = (float) (Math.cos(x / 2) * Math.cos(y / 2) * Math.sin(z / 2) - Math.sin(x / 2) * Math.sin(y / 2) * Math.cos(z / 2));
    }
